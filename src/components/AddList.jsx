        ...
        <div>
            {listOffeild.map(feildoflist => (
                <div key={feildoflist.id} className="border-solid bg-accent-content border-2 border-white rounded-lg flex text-center items-center justify-between mt-5 p-3">
                    ...
                    <div>
                        <button onClick={() => Delete(feildoflist.feild, feildoflist.id)} className="inline-flex animate-pulse items-center mr-2 p-2 bg-red-600 hover:bg-red-700 text-white text-sm font-medium rounded-md">
